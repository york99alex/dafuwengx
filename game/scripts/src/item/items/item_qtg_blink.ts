...
export class item_qtg_blink extends TSBaseItem {
    ...
    OnSpellStart(): void {
        ...
        // 特效
        let nPtclID = AHMC.CreateParticle("particles/items_fx/blink_dagger_start.vpcf"
            , ParticleAttachment.ABSORIGIN, false, player.m_eHero, 2)
        ...
        nPtclID = AHMC.CreateParticle("particles/items_fx/blink_dagger_end.vpcf"
            , ParticleAttachment.ABSORIGIN, false, player.m_eHero, 2)
        ParticleManager.SetParticleControl(nPtclID, 0, player.m_eHero.GetAbsOrigin())
