...
export class item_qtg_arcane_boots extends TSBaseItem {
    ...
    OnSpellStart(): void {
        ...
        // 特效
        AHMC.CreateParticle("particles/items_fx/arcane_boots.vpcf"
            , ParticleAttachment.POINT, false, player.m_eHero, 2)
        AHMC.CreateParticle("particles/items_fx/arcane_boots_recipient.vpcf"
            , ParticleAttachment.POINT, false, player.m_eHero, 2)
        // 音效
...
export class item_qtg_arcane_boots_modifier extends BaseModifier {
    ...
    DeclareFunctions(): ModifierFunction[] {
        return [
            ModifierFunction.MOVESPEED_BONUS_UNIQUE,
