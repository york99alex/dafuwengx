...
export class GameLoop {
    ...
    GameStateService: StateMachine.Service<
        object,
        EventObject,
        {
            value: any;
    ...
    GameStateLoop = createMachine(
        {
            ...
            states: {
                ...
                GSRoundBefore: {
                    on: { tobegin: 'GSBegin', tomove: 'GSMove', todeathclearing: 'GSDeathClearing' },
                ...
                GSWait: { on: { towaitoprt: 'GSWaitOprt', todeathclearing: 'GSDeathClearing' }, entry: 'GSWait_Entry', exit: 'GSWait_Exit' },
                GSMove: {
                    on: { towaitoprt: 'GSWaitOprt', toRoundBefore: 'GSRoundBefore', tobegin: 'GSBegin', todeathclearing: 'GSDeathClearing' },
                    entry: 'GSMove_Entry',
                    exit: 'GSMove_Exit',
                },
                GSFinished: {
                ...
                GSDeathClearing: { on: { tofinished: 'GSFinished' }, entry: 'GSDeathClearing_Entry', exit: 'GSDeathClearing_Exit' },
    ...
    GSDeathClearing_Entry() {
        ...
        this.Timer(() => {
            ...
            if (timeOprt < 0) {
                ...
                if (timeOprt % 10 == 0) EmitGlobalSound('Custom.Time.Urgent');
            }
            return 0.1;
        }, 0);
    }
