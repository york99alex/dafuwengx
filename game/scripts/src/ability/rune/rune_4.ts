...
export class modifier_rune_4 extends BaseModifier {
    ...
    OnCreated(params: object): void {
        ...
        // 加蓝特效
        let nPtclID = AHMC.CreateParticle("particles/econ/items/outworld_devourer/od_shards_exile/od_shards_exile_prison_start.vpcf"
            , ParticleAttachment.OVERHEAD_FOLLOW, false, oPlayer.m_eHero, 2)
        ...
        for (const eBZ of oPlayer.m_tabBz) {
            ...
            nPtclID = AHMC.CreateParticle("particles/econ/items/outworld_devourer/od_shards_exile/od_shards_exile_prison_start.vpcf"
                , ParticleAttachment.OVERHEAD_FOLLOW, false, eBZ, 2)
