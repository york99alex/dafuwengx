import { TP_MONSTER_2, TP_SHOP_SECRET, TP_SHOP_SIDE, TP_START } from '../../constants/gamemessage';
...
export class Card_MONSTER_LARGE extends Card {
    ...
    OnSpellStart(): void {
        ...
        const paths = GameRules.PathManager.getPathByType(TP_MONSTER_2) as PathMonster[];
