import { TP_DOMAIN_1, TP_DOMAIN_2, TP_DOMAIN_6, TP_DOMAIN_7, TP_DOMAIN_End, TP_MONSTER_1, TP_MONSTER_2, TP_MONSTER_3, TP_PRISON, TP_RUNE, TP_SHOP_SECRET, TP_SHOP_SIDE, TP_START, TP_STEPS, TP_TP, TP_TREASURE } from "../mode/gamemessage"
    ...
    static create(entity: CBaseEntity) {
        ...
        if (typePath >= TP_DOMAIN_1 && typePath < TP_DOMAIN_End) {
            ...
            switch (typePath) {
                ...
                case TP_SHOP_SIDE | TP_SHOP_SECRET:
